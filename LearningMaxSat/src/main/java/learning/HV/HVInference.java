...
public class HVInference {
    ...
    private ArrayList<VariableX> variablesX = new ArrayList<VariableX>();
    private ArrayList<VariableD> variablesD = new ArrayList<VariableD>();
    private ArrayList<VariableF> variablesF = new ArrayList<VariableF>();
